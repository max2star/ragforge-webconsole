...
import OllamaEditModal from './ollama-edit-modal';
...
interface IModelCardProps {
  ...
  onEditModel: (e: any) => void;
}

const ModelCard = ({ item, clickApiKey, onEditModel }: IModelCardProps) => {
  ...
  const items: CollapseProps['items'] = [
    {
      ...
      children: (
        <List
          ...
          dataSource={llmList}
          renderItem={(item) => (
            <ModelCard item={item} clickApiKey={handleAddModel} onEditModel={handleEditModel}></ModelCard>
          )}
        />
      ),
    },
  ...
  return (
    <section id="xx" className="w-full space-y-6">
      ...
      <OllamaEditModal
        ...
        onOk={onLlmEditOk}
        loading={llmEditLoading}
        llmFactory={selectedEditLlmFactory}
      />
      <VolcEngineModal
